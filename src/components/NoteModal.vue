        ...
        >
          ...
          <form @submit.prevent="handleSubmit" class="flex flex-col flex-1 overflow-hidden">
            <div class="px-4 py-3 space-y-3 overflow-y-auto flex-1 min-w-0">
              ...
              <div v-if="logEntryId && !note" class="bg-accent/10 border border-accent/20 text-accent text-xs rounded-md p-2.5">
                Esta nota se guardará como nota extra de la actividad.
              </div>

              <div class="space-y-1 min-w-0">
                <div class="flex items-center justify-between gap-2">
                  <label for="note-content" class="block text-xs font-medium text-text-secondary">
