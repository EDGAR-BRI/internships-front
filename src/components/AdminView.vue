...
import { useAdmin, type AdminUser, type AdminUserDetail } from '../composables/useAdmin'
...
const sortKey = ref<'name' | 'days' | 'hours' | 'attendances' | 'notes' | 'activities' | 'lastActivity' | null>(null)
  ...
  <div class="space-y-6">
      ...
      <div class="bg-surface border border-border rounded-xl p-5">
        ...
        <div v-if="topUsers.length" class="space-y-3">
          <div v-for="u in topUsers" :key="u.id" class="flex items-center gap-3">
            <div
              class="w-7 h-7 rounded-full bg-accent/10 text-accent flex items-center justify-center text-[10px] font-semibold flex-shrink-0"
            >
    ...
    <div>
      <div class="flex items-center justify-between mb-2">
        ...
        <p v-if="loading" class="text-xs text-text-muted">Cargando...</p>
      </div>
      ...
      <div v-else class="space-y-2">
        ...
        <div
          class="hidden md:grid md:grid-cols-12 md:items-center md:gap-3 px-4 py-2"
        >
